...
exports.generatePages = exports.copyAssets = exports.SiteGenerator = exports.addSequenceLinks = exports.createPage = exports.createPagesFromFiles = void 0;
...
var getDefaultLink = function (data) {
...
function createPagesFromFiles(params) {
    ...
    var getLink = params.getLink || getDefaultLink;
...
function createPage(params) {
    var data = params.data, render = params.render, link = params.link, siteData = params.siteData;
    ...
    return new Promise(function (resolve, reject) {
        async_1.each(pages, function (page, cb) {
            page.render(page.data).then(function (renderedContent) {
                var outFileDir = path.join(outDir, page.data._meta.link);
                var outPath = path.join(outFileDir, 'index.html');
                createDir(outFileDir, function (err) {
                    if (err) {
                        reject(err);
                        return;
                    }
